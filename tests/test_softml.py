...
from softml.core.softml import evaluate_linear_regression, evaluate_random_forest
...
class SoftMLTest(unittest.TestCase):
    ...
    def setUp(self):
            ...
            self.df2 = pd.read_csv("../resources/BostonHousingDataset/housing.data",\
    ...
    def test_soft_test_dataframe_peformance(self) :

        # Performance validation on BostonHousingDataset
        # Performance is compared to 
        # https://machinelearningmastery.com/regression-tutorial-keras-deep-learning-library-python/

        response = soft_test_dataframe(self.df2, 13, train_size = self.TRAIN_SIZE, random_state = self.random_state)
